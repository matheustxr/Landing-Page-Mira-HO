...
export const Footer = () => {
  return (
    <div className="bg-terciario flex ps-10 pt-14 pb-14 flex-col gap-3 lg:items-center lg:items-center lg:gap-5 lg:ps-40 lg:pe-40 lg:pt-10 lg:pb-10 text-white text-xl">
