...
export default function Section4() {
    return (
        <section className=" gap-20">
            <div className="w-full flex-1 px-5 lg:px-0 bg-gradient-to-r  from-[#1539f1] to-[#020317] animateGradientX text-white">
                <div className="pt-28 pb-28 flex flex-col items-center">
