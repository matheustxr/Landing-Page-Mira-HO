...
export default function Contato(){
    return(
        <>
            <section className="w-full flex flex-col justify-between lg:flex-row text-white lg:h-5/6  relative ">
                <div className="w-full flex flex-1 py-20 lg:ps-40 lg:pt-20 lg:pb-20 flex-col items-center lg:items-start">
                    ...
                    <a href="#" className="" >
                        <button className="p-4 mt-10  w-[360px] lg:min-w-[370px] flex items-center justify-center rounded-xl text-xl font-semibold bg-[#00000061] border-4 animate-neon-pulse px-10">
