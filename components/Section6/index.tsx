...
export const Section6 = () => {
  return (
    <section className="w-full flex flex-col-reverse lg:flex-row-reverse gap-20 px-5 py-10  lg:p-40  bg-[#020617] text-white">
        <Image className="md:w-2/6 lg:w-3/6" src={SobreSallus} alt="Sallus"/>
        <div className="flex flex-col flex-1 items-start justify-center text-left lg:text-left">
