...
export const Section3 = () => {
  return (
    <div className="px-7 py-10 lg:p-40  ">
        <h1 className=" lg:text-center pb-10 text-3xl font-semiboldgi lg:text-5xl text-white">Hospital Oftalmológico com Estrutura de Primeiro Mundo e Valores Acessíveis</h1>
        <div className="grid lg:grid-cols-3 items-center justify-center gap-3 text-center text-white">
            <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-[#020317] p-6 lg:p-14">
